                    ...
                    <div className='row'>
                        <div className='col-4'>
                            ...
                            <address className='fs-6 text-white'>
                                Address: 37 Ho Quy Ly, <br /> Thanh Khe, Da Nang<br />
                                Pincode: 500000
                            </address>
                            <a href="tel:0901972747" className='mt-4 d-block mb-1 text-white' >Tel: +84 328461516</a>
                            <a href="mail:dovantai112344@gmail.com" className='mt-4 d-block mb-4 text-white' >Mail: conghc31@gmail.com</a>
                ...
                <div className='container-xxl'>
                    <div className='row'>
                        <div className='col-12 text-white'>
                            <p className='text-center'>&copy; {date} : Design By Mike</p>
                        </div>
                    </div>
                </div>
            </footer>
