                    ...
                    <div className='d-flex justify-content-between'>
                        ...
                        <div className='special-product-content w-50'>
                            ...
                            <div className='prod-count mt-3'>
                                <p ><strong>Tác Giả:</strong> {productState[0]?.brand}</p>
                                <p ><strong>Thể Loại:</strong> {productState[0]?.prodCategory}</p>
                                <p ><strong>Lượt xem:</strong> 20</p>
                                <div class="progress">
                ...
                <div className='special-product-card'>
                    <div className='d-flex justify-content-between'>
                        ...
                        <div className='special-product-content w-50'>
                            ...
                            <div className='prod-count mt-3'>
                                <p ><strong>Tác Giả:</strong> {productState[1]?.brand}</p>
                                <p ><strong>Thể Loại:</strong> {productState[1]?.prodCategory}</p>
                                <p ><strong>Lượt xem:</strong>10</p>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" style={{ width: "25%" }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
