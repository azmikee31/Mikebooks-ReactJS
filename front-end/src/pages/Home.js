                    ...
                    <div className='row'>
                        <div className='col-6'>
                            <div className='main-banner position-relative'>
                                <img src="images/product/op2.jpg" alt="main-banner" className='img-fluid rounded-3' />
                                <div className='main-banner-content position-absolute'>
                                    <h4>Những tập truyện mới nhất</h4>
                                    <h5>One Piece</h5>
                                    <p>Bản quyền Mike Books</p>
                        ...
                        <div className='col-6 d-flex flex-wrap gap-2 justify-content-between align-items-center'>
                            <div className='small-banner position-relative '>
                                <img src="images/product/blw.webp" alt="small-banner" className='img-fluid rounded-3' />
                            ...
                            <div className='small-banner position-relative '>
                                <img src="images/product/st.jpg" alt="small-banner" className='img-fluid rounded-3' />
                                <div className='small-banner-content content-title position-absolute'>
                                    <h4 className='text-white fw-bold fs-4'>Trinh Thám</h4>
                                </div>
                            </div>
                            <div className='small-banner position-relative '>
                                <img src="images/product/isekai.jpg" alt="small-banner" className='img-fluid rounded-3' />
                                <div className='small-banner-content content-title position-absolute'>
                                    <h4 className='text-white fw-bold fs-5'>Xuyên Không</h4>
                                </div>
                            </div>
                            <div className='small-banner position-relative '>
                                <img src="images/product/2.jpg" alt="small-banner" className='img-fluid rounded-3' />
                                <div className='small-banner-content content-title position-absolute '>
